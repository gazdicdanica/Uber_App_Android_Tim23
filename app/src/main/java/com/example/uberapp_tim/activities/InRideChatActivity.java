...
public class InRideChatActivity extends AppCompatActivity {
        ...
        ServiceUtils.userService.getMessagesForUsersByRide(jwt, user2id, user1id, rideId).enqueue(new Callback<ResponseBody>() {
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                try {
                    ...
                    Toast.makeText(InRideChatActivity.this, "update", Toast.LENGTH_SHORT).show();
                    ...
                    mMessageRecycler.setAdapter(new MessageAdapter(InRideChatActivity.this, messages));
